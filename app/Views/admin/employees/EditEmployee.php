    ...
    <div class="flex flex-col mx-4 my-4">
        ...
        <div class="md:w-1/2 md:mr-8">
                <div class="my-4">
                    ...
                    <input type="text" name="user_fullname" value="<?= $data[5][0]["user_fullname"] ?>" placeholder="Enter Fullname" required class="border rounded px-2 py-2 w-full focus:outline-none focus:bg-white focus:border-blue-500"></input>
                </div>
                <div class="my-4">
                    <div class="mr-4 pb-1 md:w-1/2"><label for="Email" class="text-sm">Email <span class="text-red-500">*</span></label></div>
                    <input type="email" name="user_email" value="<?= $data[5][0]["user_email"] ?>" placeholder="Enter Email" required class="border rounded px-2 py-2 w-full focus:outline-none focus:bg-white focus:border-blue-500"></input>
                </div>
                <div class="my-4">
                    <div class="mr-4 pb-1 md:w-1/2"><label for="Password" class="text-sm">Password <span class="text-red-500"></span></label></div>
                    <div class="flex">
                    <input type="password" name="user_password" placeholder="Enter Password" class="border rounded px-2 py-2 w-full mr-4 focus:outline-none focus:bg-white focus:border-blue-500"></input>
                    <input type="password" name="user_confirm_password" placeholder="Confirm Password" class="border rounded px-2 py-2 w-full focus:outline-none focus:bg-white focus:border-blue-500"></input>
                    </div>
                </div>
                <div class="my-4">
                    ...
                    <select name="user_gender" required class="form-select appearance-none block w-full px-3 py-2 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:outline-none focus:bg-white focus:border-blue-500" aria-label="Default select example">
                        ...
                        <?php foreach($data[4] as $gender) : ?>
                        <option value="<?= $gender["gender_id"] ?>" <?= $gender["gender_id"] == $data[5][0]["user_gender_id"] ? 'selected' : '' ?>><?= $gender["gender_name"] ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
            </div>
            <div class="md:w-1/2 md:mr-8">
                <div class="my-4">
                    <div class="mr-4 pb-1 md:w-1/2"><label for="Location" class="text-sm">Location <span class="text-red-500">*</span></label></div>
                    <select name="user_location" required class="form-select appearance-none block w-full px-3 py-2 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:outline-none focus:bg-white focus:border-blue-500" aria-label="Default select example">
                        <option disabled value="">Select Location</option>
                        <?php foreach($data[0] as $location) : ?>
                        <option value="<?= $location["location_id"] ?>" <?= $location["location_id"] == $data[5][0]["user_location_id"] ? 'selected' : '' ?>><?= $location["location_name"] ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="my-4">
                    ...
                    <select name="user_department" required class="form-select appearance-none block w-full px-3 py-2 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:outline-none focus:bg-white focus:border-blue-500" aria-label="Default select example">
                        ...
                        <option value="<?= $department["department_id"] ?>" <?= $department["department_id"] == $data[5][0]["user_department_id"] ? 'selected' : '' ?>><?= $department["department_name"] ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="my-4">
                    ...
                    <select name="user_sub_department" required class="form-select appearance-none block w-full px-3 py-2 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:outline-none focus:bg-white focus:border-blue-500" aria-label="Default select example">
                        ...
                        <option value="<?= $sub_department["sub_department_id"] ?>" <?= $sub_department["sub_department_id"] == $data[5][0]["user_sub_department_id"] ? 'selected' : '' ?>><?= $sub_department["sub_department_name"] ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="my-4">
                    ...
                    <select name="user_role" required class="form-select appearance-none block w-full px-3 py-2 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:outline-none focus:bg-white focus:border-blue-500" aria-label="Default select example">
                        ...
                        <?php foreach($data[3] as $roles) : ?>
                        <option value="<?= $roles["user_role_id"] ?>" <?= $roles["user_role_id"] == $data[5][0]["user_user_role_id"] ? 'selected' : '' ?>><?= $roles["user_role_name"] ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
            </div>
