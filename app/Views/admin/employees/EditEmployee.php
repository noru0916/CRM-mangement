    ...
    <div class="flex flex-col mx-4 my-4">
        ...
        <div class="md:w-1/2 md:mr-8">
                <div class="my-4">
                    ...
                    <input type="text" name="user_fullname" value="<?= $data[5][0]["user_fullname"] ?>" placeholder="Enter Fullname" required class="border rounded px-2 py-2 w-full"></input>
                </div>
                <div class="my-4">
                    <div class="mr-4 pb-1 md:w-1/2"><label for="Email" class="text-sm">Email <span class="text-red-500">*</span></label></div>
                    <input type="email" name="user_email" value="<?= $data[5][0]["user_email"] ?>" placeholder="Enter Email" required class="border rounded px-2 py-2 w-full"></input>
                </div>
                <div class="my-4">
                    <div class="mr-4 pb-1 md:w-1/2"><label for="Password" class="text-sm">Password <span class="text-red-500"></span></label></div>
                    <div class="flex">
                    <input type="password" name="user_password" placeholder="Enter Password" class="border rounded px-2 py-2 w-full mr-4"></input>
                    <input type="password" name="user_confirm_password" placeholder="Confirm Password" class="border rounded px-2 py-2 w-full"></input>
                    </div>
                </div>
                <div class="my-4">
