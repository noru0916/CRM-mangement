...
<body class="transition-all ease-in-out">
    <div class="flex transition-all">
        <nav class="hidden md:flex flex-col justify-between h-screen sticky top-0 w-0 md:w-56 border-r border-gray-200 dark:border-background-darkSecondary dark:bg-background-darkPrimary transition-all">
            ...
            <div class="flex flex-col border-t dark:border-background-darkSecondary py-4 transition-all">
